...
const CHARACTERS = {
  ...
  greeter: {
    ...
    basePath: EMO_BASE_PATH,
    isLive2D: true,
    liveModel: "greeter",   // live2d-emotion.js가 참조하는 모델 키
    intro: (name) => {
      const lines = [
        "어서 오세요! 접수원 하루입니다. 무엇을 도와드릴까요?",
        "안녕하세요, 하루예요. 필요하신 게 있으면 편하게 말씀해 주세요.",
...
function setCurrentCharacter(key) {
  ...
  // Live2D 활성화 플래그 설정
  window._live2dActive = true; // 하루/접수원 하루 모두 Live2D
